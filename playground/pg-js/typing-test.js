...
const wordBank = [ "ability", "able", "about", "above", "accept", "according", "account", "across", "action", "activity",
    ...
    "increase", "indeed", "individual", "industry", "information", "inside", "instead", "institution", "interest", "interesting",
    ...
    "yes", "yet", "you", "young", "your", "yourself" ]; // Custom word bank
...
function getRandomText() {
    testText = wordBank.sort(() => 0.5 - Math.random()).slice(0, 20).join(" ");
...
typingArea.addEventListener('input', () => {
    ...
    for (let i = 0; i < typedText.length; i++) {
        if (typedText[i] === testText[i]) {
            correctCharacters++;
            textToType.children[i].classList.add('correct');
            textToType.children[i].classList.remove('incorrect');
        } else {
            textToType.children[i].classList.add('incorrect');
            textToType.children[i].classList.remove('correct');
        }
    }
